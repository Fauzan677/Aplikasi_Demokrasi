...
class keresahanAdapter1(private val dataList: List<keresahan1>) :
    RecyclerView.Adapter<keresahanAdapter1.ViewHolder>() {
    ...
    class ViewHolder(itemView: View, listener: keresahanAdapter1.onItemClickListener) : RecyclerView.ViewHolder(itemView) {
