...
class beritaAdapter1(private val dataList: List<berita1>) :
    RecyclerView.Adapter<beritaAdapter1.ViewHolder>() {
    ...
    class ViewHolder(itemView: View, listener: beritaAdapter1.onItemClickListener) : RecyclerView.ViewHolder(itemView) {
